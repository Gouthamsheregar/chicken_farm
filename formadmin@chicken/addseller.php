...
<html lang="en">
  <head>
    ...
    <title>Chicken farm-Admin add seller panel</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
       <li><a class="app-menu__item" href="index.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">
		...
		<li><a class="app-menu__item active" href="addseller.php"><i class="app-menu__icon fa fa-plus"></i><span class="app-menu__label">Add Seller</span></a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> Add Seller</h1>
        </div>
      </div>
	  <?php
	include("config.php");
	$sql1= "select sellerno from seller";
	...
	?>
          <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Seller Registeration</h3>
            <div class="tile-body">
              <form class="form-horizontal" action="#" method="post">
			  <div class="form-group row">
                  <label class="control-label col-md-3">Seller Number</label>
                  <div class="col-md-8">
                    <input class="form-control" type="text" value="<?php echo $selno; ?>" name="sellerno" readonly="true">
                  </div>
                </div>
                <div class="form-group row">
				...
				<div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="tel" placeholder="Enter Personal Number" title="8n or more" name="contactno" required>
                  </div>
                </div>
                <div class="form-group row">
				...
				<div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" name="gstno" placeholder="Enter GST No" required>
                  </div>
                </div>
            </div>
            <div class="tile-footer">
              <div class="row">
                <div class="col-md-8 col-md-offset-3">
                  <button class="btn btn-primary" type="submit" name="register"><i class="fa fa-fw fa-lg fa-check-circle"></i>Register</button>
                </div>
              </div>
            </div>
			</form>
...
if(isset($_POST['register']))
{
	...
	if($count>0)
	{
		...
		echo "<script>
			...
			echo "<script> location.href='addseller.php'; </script>";
	}
	else
	{
		...
		$Gender=$_POST['gender'];
		$GSTno=$_POST['gstno'];
		$query = "insert into seller(sellerno,sellername,email,contactno,address,gender,gstno) values('".$Sellerno."','".$Name."','".$Email."','".$Contactno."','".$Address."','".$Gender."','".$GSTno."')";
...
?>
		...
		<div class="page-header text-white bg-primary">
              <center><h3 class="mb-3 line-head" id="buttons">Seller Details</h3></center>
          </div>
          <div class="tile">
			...
			?>
              <tbody>
                <tr>
				  ...
				  <input type="text" name="id[]" value="<?php echo $sellerid; ?>" hidden="true">
...
if(isset($_POST['delete']))
{
	...
	$query1 = "delete from seller where sellerid='".$selectid."'";
